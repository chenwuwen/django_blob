...
(function (factory) {
                ...
                for (var i in json) {
                    for (var x in json[i]) {
                        ...
                        if (color) {
                            ...
                            sheet += '<a href="javascript:;" class="pui-bg-' + name + '" name="' + name + '" color="' + color + ' "title="' + name + '" style="z-js:' + (total--) + '"></a>';
                        }
                    }
                }
    ...
    (function ($) {
        ...
        $.formValidatorRuleMessages = {
            ...
            vcode: {
                empty: $.formValidatorIcons.error + ' 错误：验证码不能为空。',
                error: $.formValidatorIcons.error + ' 错误：验证码错误。',
            }
        };
        ...
        $.fn.formValidator = function (options, ajaxSubmit, _messages) {
            ...
            for (var i in options) {
                ...
                //     console.log("element 是jquery对象")
                //     console.log("jquery对象转换为DOM对象")
            ...
            $(selector).each(function () {
                ...
                var handle = function () {
                    ...
                    if (settings.showMode === "fade") {
                        ...
                        if (position === "left") {
                            if (side.is(":hidden")) {
                                side.css({left: "-" + side.outerWidth() + "px"}).animate({
                                    left: 0,
                                    opacity: "show"
                                }, settings.speed);
                            }
                        ...
                        if (position === "right") {
                            if (side.is(":hidden")) {
                                side.css({right: "-" + side.outerWidth() + "px"}).animate({
                                    right: 0,
                                    opacity: "show"
                                }, settings.speed);
                            }
            ...
            $(this).each(function () {
                ...
                tabHead.bind($.clickOrTouch(), function () {
                    ...
                    if (showMode == "fade") {
                        ...
                        //console.log(boxList.html(), js * box[0].offsetWidth);
                        ...
                        //console.log(boxList.html(), js * box.outerHeight());
    ...
    window.Modernizr = (function (window, document, undefined) {
        ...
        //
        // Codec values from : github.com/NielsLeenheer/html5test/blob/9106a8/js.html#L845
